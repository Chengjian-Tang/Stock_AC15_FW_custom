...
function getMoreFolder(folderId, subData) {
    ...
    if ($("#" + folderId).html() !== "") {
        ...
        //显示搜索图标
        $(".folder-scan").css("background", "url(/img/scan.gif?a6ae186598b34aee5d843bc4693eda1e) 0 no-repeat");
