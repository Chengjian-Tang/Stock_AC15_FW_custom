...
R.extend(R, {
	...
	isTimeOut: function (str) {
		if (str.indexOf("<!DOCTYPE html") === 0 && str.indexOf("login.js?a6ae186598b34aee5d843bc4693eda1e") != -1) {
			return true;
		}
...
function translateDeviceType(str) {
	...
	if (top.G.deviceList.indexOf(str) != -1) {
		...
		//设备未支持的手机图标
		obj = {
			src: "./img/device/others.png?a6ae186598b34aee5d843bc4693eda1e",
			exsit: false,
